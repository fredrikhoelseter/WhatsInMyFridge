...
class FoodItemForm extends StatefulWidget {
  ...
  FoodItemForm({Key? key, this.child, this.user, required this.foodItems,
  required this.productNameController, required this.productCategoryController,
  required this.manufacturerController, required this.dateInput,
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (value) => Validator.validateProductField(field: value),
            ...
            TextFormField(
              ...
              validator: (value) => Validator.validateContainer(container: value),
              decoration:
              InputDecoration(
